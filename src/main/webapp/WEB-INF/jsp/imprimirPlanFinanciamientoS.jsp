...
<html>
    ...
    <table align="center" class="nover" border="0" width="585" bgcolor="F2F2F2"> <tr> <td> 
                ...
                <form id="accionForm" action="PlanFinanciamiento.pdf" method="post">
        ...
        <tr><td width="650">
                ...
                <table style="font-size:8px;font-family:arial;text-align:center">  
                    <tr>
                        <td>
                            <table cellspacing="0" align="right" cellpadding="-1" style="font-size:12px;font-family:arial">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <table style="background: #D8D8D8; text-align: center;" width="200">
                                            <tr>
                                                <td>
                                                    <p/>
                                                </td>
                    ...
                    <tr><td>
                            ...
                            <table  style="font-size:8px;font-family:arial" align="center" cellspacing="0"> 
                                <tr> 
                ...
                <br>
                <table style="font-size:8px;font-family:arial;text-align:center">	
                    <tr><td width="600" align="left"><b><fmt:message key="etq.simulado.datos_prestamo"/></b></td> 
                    </tr>
                    <tr><td>
                                                ...
                                                <td colspan="4">
                                                    <table  style="font-size:8px;font-family:arial;align:center"  cellspacing="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td width="20">&nbsp;</td>
                                                            <td width="150" align="center">${presol.prstamoOrigVO.auxNumPrestamo}</td>
                                                            <td width="200" align="center"><p/></td>
                                                            <td width="150" align="center">${presol.prstamoOrigVO.auxFechaPrestamo}</td> 
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td width="15">&nbsp;</td>
                                                            <td width="150" align="center" > <fmt:message key="etq.planfinanc.numeroPrestamo"/></td>
                                                            <td width="150" align="center"><p/></td>
                                                            <td width="150" align="center" > <fmt:message key="etq.planfinanc.fechaPrestamo"/></td>
                                                        </tr>
                                                        <tr><td><br/></td></tr>
                                                    </table>
                                                </td>   
                    ...
                    <tr><td><br/></td></tr>
                    <tr><td width="600" align="left"><b><fmt:message key="etq.planfinanc.prestamoOtorgado"/></b></td> 
                    </tr>
                    <tr>
                        <td>
                            <table border="1"> 
                                <tr><td><br>
                                        <table style="font-size:8px;font-family:arial" align="center" cellspacing="0" cellspacing="0"> 
                                            <tr> 
                                                <td width="600" colspan="4" align="left"><fmt:message key="etq.planfinanc.notaCajaPrestamo"/></td>
                                        ...
                                        <table  style="font-size:8px;font-family:arial; text-align: left;" align="left" cellspacing="0" cellspacing="0">
                                            <tr><td><b><fmt:message key="etq.planfinanc.nota.pie"/></b></td></tr>
                                            <tr><td><fmt:message key="etq.planfinanc.nota.piePuntoUno"/></td></tr>
                                            <tr><td><fmt:message key="etq.planfinanc.nota.piePuntoDos"/></td></tr>
                                            <tr><td><fmt:message key="etq.planfinanc.nota.piePuntoTres"/></td></tr>
                                            <tr><td><fmt:message key="etq.planfinanc.nota.piePuntoCuatro"/></td></tr>
                                            <tr><td><fmt:message key="etq.planfinanc.nota.piePuntoCinco"/></td></tr>
                                            <tr><td><br/></td></tr>
                                            <tr><td><fmt:message key="etq.planfinanc.nota.pieS"/></td></tr>
                                            <tr><td><br/></td></tr>
