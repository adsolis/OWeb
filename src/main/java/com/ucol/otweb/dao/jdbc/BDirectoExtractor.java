 ...
 * @author 
 */
public class BDirectoExtractor implements ResultSetExtractor<DirectoVO> {

    public DirectoVO extractData(ResultSet rs) throws SQLException, DataAccessException {
        DirectoVO directo = new DirectoVO();
